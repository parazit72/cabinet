@section('canonical', env('APP_URL').'/construction')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="hero-content">
                    ...
                    <p data-aos="fade-up" data-aos-duration="2500">
                        Revitalize your space with our comprehensive construction and renovation services. From concept
                        to completion, we seamlessly blend innovation with craftsmanship to transform your vision into
                        reality. Whether it's a residential or commercial project, our experienced team works tirelessly
                        to exceed expectations while adhering to timelines and budgets. With a keen eye for detail and a
                        commitment to quality, we breathe new life into homes, offices, and beyond. Trust us to elevate
                        your environment with our expertise and dedication to excellence in every aspect of construction
                        and renovation.
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                <div class="hero-inner-img">
                    <img src="assets/img/hero/project-hero.jpg" alt data-aos="fade-left" data-aos-duration="2000" />
                    <img src="assets/img/hero/project-hero2.jpg" alt class="hero-inner-2" data-aos="fade-up"
